...
public class LocationDAO implements LocationRepository {
    ...
    // connects to choice 1 in the Console UI
    @Override
    ...
    // connects to choice 2 in the Console UI
    @Override
    ...
    // choice 5 (search location) in the Console UI
    @Override
    ...
    // controls existence of inputted location on updateLocation() method in ConsoleUI
    @Override
